        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
              AI-Powered Copy Trading on Aptos
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl text-gray-200">
              Start copying pro traders with just 1 click. Let AI find the best
              performers for you.
            </p>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container px-4 md:px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Start Copying Pro Traders?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-200">
            Join thousands of traders who are already leveraging AI to boost
